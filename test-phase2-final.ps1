...
try {
  ...
  Write-Host "Mock Tests endpoint failed" -ForegroundColor Red
}
...
try {
  ...
  Write-Host "Exams endpoint failed" -ForegroundColor Red
}
...
try {
  ...
  Write-Host "Results endpoint failed" -ForegroundColor Red
}
...
try {
  ...
  Write-Host "Certificates endpoint failed" -ForegroundColor Red
}
...
try {
  ...
  Write-Host "Answers endpoint failed" -ForegroundColor Red
}
...
Write-Host "`nAll Phase 2 backend APIs operational!" -ForegroundColor Green
...
Write-Host "  http://localhost:5173/trainer" -ForegroundColor Gray

Write-Host "`nBackend: http://localhost:8080" -ForegroundColor Yellow
Write-Host "Database: MySQL jet_db" -ForegroundColor Yellow
